...
const Header = () => {
  ...
  const { challenge, selectedChallenge } = challengeContext;
  ...
  return (
    <>
      ...
      <div className="menu-challenge-two">
        <h2>Información de los Episodios y Personajes</h2>
        <div className="challenge-two-content">
          <div className={challenge && challenge === '2-all' ? 'second-all' : null} onClick={() => selectedChallenge('2-all', null)}>
            <p>Mostrar Cantidad y Listado</p><span>(Episodio - Personaje)</span>
          </div>
        </div>
      </div>
    </>
